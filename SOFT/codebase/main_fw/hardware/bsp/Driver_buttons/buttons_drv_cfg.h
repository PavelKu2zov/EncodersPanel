...
#define BUTTONS_ACTIVE_CH0        (BUTTONS_ACTIVE_STATE_HIGH)
...
#define BUTTONS_ACTIVE_CH1        (BUTTONS_ACTIVE_STATE_HIGH)
...
#define BUTTONS_ACTIVE_CH2        (BUTTONS_ACTIVE_STATE_HIGH)
