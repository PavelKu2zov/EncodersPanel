...
extern "C"
{
     ...
     * DEFINES
     ******************************************************************************/
#define CONTROL_ENCODER_SW7_VAR4_CC    (109) // Right, SW11_pos1, SW8_pos1, button_ON
#define CONTROL_ENCODER_SW7_VAR4_DATA  (110)
#define CONTROL_ENCODER_SW7_VAR6_CC    (113) // Left, SW11_pos1, SW8_pos1, button_ON
#define CONTROL_ENCODER_SW7_VAR6_DATA  (114)
...
#define CONTROL_ENCODER_SW7_VAR5_CC    (111) // Right, SW11_pos1, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW7_VAR5_DATA  (112)
#define CONTROL_ENCODER_SW7_VAR7_CC    (115) // Left, SW11_pos1, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW7_VAR7_DATA  (116)
#define CONTROL_ENCODER_SW7_VAR13_CC   (127) // Right, SW11_pos2, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW7_VAR13_DATA (128)
#define CONTROL_ENCODER_SW7_VAR15_CC   (131) // Left, SW11_pos2, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW7_VAR15_DATA (132)
...
#define CONTROL_ENCODER_SW7_VAR0_CC    (101) // Right, SW11_pos1, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR0_DATA  (102)
#define CONTROL_ENCODER_SW7_VAR2_CC    (105) // Left, SW11_pos1, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR2_DATA  (106)
#define CONTROL_ENCODER_SW7_VAR8_CC    (117) // Right, SW11_pos2, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR8_DATA  (118)
#define CONTROL_ENCODER_SW7_VAR10_CC   (121) // Left, SW11_pos2, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR10_DATA (122)
#define CONTROL_ENCODER_SW7_VAR16_CC   (133) // Right, SW11_pos3, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR16_DATA (134)
#define CONTROL_ENCODER_SW7_VAR18_CC   (137) // Left, SW11_pos3, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW7_VAR18_DATA (138)
#define CONTROL_ENCODER_SW7_VAR1_CC    (103) // Right, SW11_pos1, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR1_DATA  (104)
#define CONTROL_ENCODER_SW7_VAR3_CC    (107) // Left, SW11_pos1, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR3_DATA  (108)
#define CONTROL_ENCODER_SW7_VAR9_CC    (119) // Right, SW11_pos2, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR9_DATA  (120)
#define CONTROL_ENCODER_SW7_VAR11_CC   (123) // Left, SW11_pos2, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR11_DATA (124)
#define CONTROL_ENCODER_SW7_VAR17_CC   (135) // Right, SW11_pos3, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR17_DATA (136)
#define CONTROL_ENCODER_SW7_VAR19_CC   (139) // Left, SW11_pos3, SW8_pos2, button_OFF
#define CONTROL_ENCODER_SW7_VAR19_DATA (140)

#define CONTROL_ENCODER_SW12_VAR4_CC    (109) // Right, SW11_pos1, SW8_pos1, button_ON
#define CONTROL_ENCODER_SW12_VAR4_DATA  (110)
#define CONTROL_ENCODER_SW12_VAR6_CC    (113) // Left, SW11_pos1, SW8_pos1, button_ON
#define CONTROL_ENCODER_SW12_VAR6_DATA  (114)
...
#define CONTROL_ENCODER_SW12_VAR15_CC   (131) // Left, SW11_pos2, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW12_VAR15_DATA (132)
#define CONTROL_ENCODER_SW12_VAR21_CC   (143) // Right, SW11_pos3, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW12_VAR21_DATA (144)
#define CONTROL_ENCODER_SW12_VAR23_CC   (147) // Left, SW11_pos3, SW8_pos2, button_ON
#define CONTROL_ENCODER_SW12_VAR23_DATA (148)
#define CONTROL_ENCODER_SW12_VAR0_CC    (101) // Right, SW11_pos1, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW12_VAR0_DATA  (102)
#define CONTROL_ENCODER_SW12_VAR2_CC    (105) // Left, SW11_pos1, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW12_VAR2_DATA  (106)
...
#define CONTROL_ENCODER_SW12_VAR16_CC   (133) // Right, SW11_pos3, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW12_VAR16_DATA (134)
#define CONTROL_ENCODER_SW12_VAR18_CC   (137) // Left, SW11_pos3, SW8_pos1, button_OFF
#define CONTROL_ENCODER_SW12_VAR18_DATA (138)
...
#define CONTROL_ENCODER_SW9_VAR0_CC    (30) // Right, SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW9_VAR0_DATA  (31)
#define CONTROL_ENCODER_SW9_VAR2_CC    (34) // Left, SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW9_VAR2_DATA  (35)
...
#define CONTROL_ENCODER_SW9_VAR11_CC   (52) // Left, SW11_pos3, SW8_pos2
#define CONTROL_ENCODER_SW9_VAR11_DATA (53)

#define CONTROL_ENCODER_SW10_VAR0_CC    (30) // Right, SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW10_VAR0_DATA  (31)
#define CONTROL_ENCODER_SW10_VAR2_CC    (34) // Left, SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW10_VAR2_DATA  (35)
...
#define CONTROL_ENCODER_SW10_VAR11_CC   (52) // Left, SW11_pos3, SW8_pos2
...
#define CONTROL_ENCODER_SW4_VAR0_CC   (10) // SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW4_VAR0_DATA (20)
#define CONTROL_ENCODER_SW4_VAR1_CC   (10) // SW11_pos1, SW8_pos2
#define CONTROL_ENCODER_SW4_VAR1_DATA (20)
...
#define CONTROL_ENCODER_SW5_VAR0_CC   (10) // SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW5_VAR0_DATA (20)
#define CONTROL_ENCODER_SW5_VAR1_CC   (10) // SW11_pos1, SW8_pos2
#define CONTROL_ENCODER_SW5_VAR1_DATA (20)
...
#define CONTROL_ENCODER_SW6_VAR0_CC   (11) // SW11_pos1, SW8_pos1
#define CONTROL_ENCODER_SW6_VAR0_DATA (12)
#define CONTROL_ENCODER_SW6_VAR1_CC   (12) // SW11_pos1, SW8_pos2
#define CONTROL_ENCODER_SW6_VAR1_DATA (14)
